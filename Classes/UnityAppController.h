...
@interface UnityAppController : NSObject<UIApplicationDelegate>
{
    ...
    NSMutableDictionary* viewCtrDic;
...
@property (readonly, copy, nonatomic) NSMutableDictionary*               ViewDic;
//@property (readonly, copy, nonatomic) UIViewController*     rootViewController;
@property (readonly, copy, nonatomic) NSMutableDictionary*     ViewCtrDic;
